package com.biosense.identity.infrastructure.adapter.out.security;
...
public class JwtUtil {
    ...
    @Value("${jjwt.secret:defaultSecretKeyWithEnoughLengthForHS256Algorithm123456}")
    private String secret;

    @Value("${jjwt.expiration:86400}")
